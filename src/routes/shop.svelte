<script>
    ...
    */
    ...
    import {Helper} from "$lib/pharma/Helper";
...
<div class="wrapper" id="app">
    <div class="card-form">
                    ...
                    <div class="card-item__wrapper">
                        ...
                        <div class="card-item__content">
                            <label for="cardName" class="card-item__info" bind:this={refs.cardName}>
                                ...
                                {:else}
                                    <div in:fly={{y:-6}} class="card-item__name placeholder">Full Name</div>
                                {/if}
                            </label>
        ...
        <div class="card-form__inner">
            ...
            <div class="card-input">
                <label for="cardName" class="card-input__label">Nom du titulaire</label>
            ...
            <div class="card-form__row">
                <div class="card-form__col">
                    <div class="card-form__group">
                        <label for="cardMonth" class="card-input__label">Date de paiement</label>
