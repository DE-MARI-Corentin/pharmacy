...
<form class="max-w-sm">
    ...
    <div class="flex">
        ...
        <div class="">
            <input class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-blue-500"
                   id="inline-full-name" type="text" value="{animal.raceAnimal}">
        </div>
    </div>
    <div class="flex">
        <div class="">
        ...
        <div class="">
            <input class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-blue-500"
                   id="inline-full-name" type="text" value="{animal.typeAnimal}">
        </div>
    </div>
    <div class="flex">
        <div class="">
...
<button class="btn-blue w100 mb-4" style="border-radius: 32px">Prendre Rendez-Vous</button>
